...
| 2 | refactor retrieval.cjs to seed the domain profiles from the ark index | **ptah** | code | 5 | argmax | ptah:5 |
| 3 | why is the devnexus MCP showing pending approval | **ptah** | code | 4 | argmax | ptah:4 |
| 4 | write the scoring function for the Pharos classifier | **ptah** | code | 9 | argmax | ptah:9 |
| 5 | the gitnexus index is stale, reindex the repo | **ptah** | code | 8 | argmax | ptah:8 |
...
| 8 | book the flight to Sri Lanka before the ETA expires | **ra** | personal | 9 | argmax | ra:9 |
| 9 | remind me to call my family in Taiwan | **ra** | personal | 8 | argmax | ra:8 |
| 10 | did I journal about church last sunday | **ra** | personal | 6 | argmax | ra:6 |
| 11 | schedule a taekwondo session friday morning | **ra** | personal | 6 | argmax | ra:6 |
| 12 | plan the Malaysia leg of the summer trip | **ra** | personal | 5 | argmax | ra:5 |
...
| 15 | which Cornell courses should I take in the fall semester | **thoth** | classwork | 7 | argmax | thoth:7 |
...
| 19 | prep questions for the Juniper meeting | **horus** | career | 3 | argmax | horus:3 |
| 20 | score my resume the way a recruiter would | **horus** | career | 6 | argmax | horus:6 |
| 21 | draft a follow-up to the Planisphere intro | **horus** | career | 3 | argmax | horus:3 |
| 22 | what's a fair TC to counter the offer with | **horus** | career | 8 | argmax | horus:8 |
| 23 | update my LinkedIn headline for recruiting | **horus** | career | 3 | argmax | horus:3 |
| 24 | should I take the Mercor gig this week or focus on the curriculum | **horus** | career | 2 | argmax | horus:5 thoth:3 |
...
| 36 | skip class to prep for the juniper onsite | **horus** | career | 2 | argmax | horus:5 thoth:3 |
...
| 40 | lock in the sri lanka dates | **ra** | personal | 4 | argmax | ra:4 |
